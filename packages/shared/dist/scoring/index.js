 ...
 */
export function computeSmartScore(sliders) {
    ...
    const score = balanceScore * SLIDER_WEIGHTS.balance +
 ...
 */
export function computeBestScore(scores) {
    if (scores.length === 0)
        return 0;
 ...
 */
export function interpretBalance(balance) {
    if (balance < 4)
        return 'sour';
    if (balance > 6)
        return 'bitter';
 ...
 */
export function getExtractionAssessment(sliders) {

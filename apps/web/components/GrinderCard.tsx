      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="text-center">
            <p className="text-xs text-coffee-400 uppercase tracking-wide mb-1">Current</p>
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-coffee-100 to-coffee-200 flex items-center justify-center">
              <span className="text-2xl font-bold text-coffee-700">{current}</span>
            </div>
          </div>
          
          <div className="flex flex-col items-center">
            <span className="text-2xl text-coffee-300">→</span>
          </div>
          
          <div className="text-center">
            <p className="text-xs text-coffee-400 uppercase tracking-wide mb-1">Target</p>
          ...
          {needsAdjustment ? (
            <div>
              <p className={`text-lg font-bold mb-2 ${
                ...
                {delta.direction === 'finer' ? '⬇️' : '⬆️'} {delta.clicks} click{delta.clicks !== 1 ? 's' : ''} {delta.direction}
              </p>
              <button

 ...
 */
export function generateSuggestion(input: SuggestionInput): Suggestion {
...
function generateV60Suggestion(
  sliders: RatingSliders,
  balance: 'sour' | 'balanced' | 'bitter',
  extraction: { extraction: 'under' | 'good' | 'over'; confidence: number },
...
function generateMokaSuggestion(
  sliders: RatingSliders,
  balance: 'sour' | 'balanced' | 'bitter',
  extraction: { extraction: 'under' | 'good' | 'over'; confidence: number },
  parameters: BrewParameters

// Kissa Coffee App - Database Seed Script (Production-safe JavaScript version)
// This file is used in Docker production to seed the database with default methods
